...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try {
            ...
            if (user != null) {  //login success
                Management_Motocycle management = new Management_Motocycle();
                management.setVisible(true);   // show the main frame
                this.dispose();    // turn off login form
            } else {
    ...
    private boolean valid() {
        ...
        if (userID.isEmpty()) {
            JOptionPane.showMessageDialog(this, "User ID cannot null");
            return false;
        }
        if (password.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Password cannot null");
            return false;
        }
        return true;
    }
